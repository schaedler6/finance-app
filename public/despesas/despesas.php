                    ...
                    <?php if (count($despesas) > 0): ?>
                        <?php foreach ($despesas as $despesa): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="categoria-indicador" style="background-color: <?php echo $despesa['cor']; ?>"></span>
                                    <?php echo htmlspecialchars($despesa['categoria']); ?>
                                </td>
                                <td><?php echo htmlspecialchars($despesa['descricao']); ?></td>
                                <td class="despesas">R$ <?php echo number_format($despesa['valor'], 2, ',', '.'); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="4" style="text-align: center;">Nenhuma despesa cadastrada.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
